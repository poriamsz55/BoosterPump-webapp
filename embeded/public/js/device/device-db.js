            ...
            partCard.innerHTML = `
                ...
                <div class="card-header">
                    <div class="card-count-container">
                        ...
                        <button class="count-btn minus-btn" id="minus-${part.id}">-</button>
    ...
    attachAddedCardEventListeners() {
        ...
        partsGrid.querySelectorAll('.count-btn').forEach(button => {
            button.addEventListener('click', (e) => {
                ...
                const part = this.addedParts.find(part => part.id.toString() === partId.toString());
                if (!part) return;
                ...
                const existingPart = deviceParts.find(part => part.id.toString() === partId.toString());
                if (existingPart) {
